...
After your infrastructure is deployed, test the web application:

1. Get the load balancer URL from Terraform outputs:
   ```sh
   terraform output
   ```

2. Open the URL in your browser (it may take a minute for the instances to be healthy)

3. Refresh the page a few times - you should see traffic being distributed across your EC2 instances
