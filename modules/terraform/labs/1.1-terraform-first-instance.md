...
1. In **Visual Studio Code**, click the **Extensions** icon in the left sidebar (or press `Ctrl+Shift+X`)
2. Search for **HashiCorp Terraform**
3. Click **Install** on the extension by HashiCorp
4. Wait for the installation to complete

This extension provides syntax highlighting, IntelliSense, and command palette integration for Terraform.
...
Terraform will create an AWS EC2 instance as specified in your configuration. Log into your AWS account and find the instance.
