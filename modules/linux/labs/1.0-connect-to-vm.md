...
2. In Visual Studio Code, click **Clone Repository** and paste `https://github.com/innovationinsoftware/bc-platform-engineer-mainframe`
...
Host Linux
  ...
  IdentityFile ~/Documents/bc-platform-engineer-mainframe/modules/linux/labs/keys/lab.pem
  User ec2-user
```
